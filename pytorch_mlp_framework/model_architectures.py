...
class ConvolutionalBNRCProcessingBlock(nn.Module):
    def __init__(
        self,
        input_shape,
        num_filters,
        ...
        super(ConvolutionalBNRCProcessingBlock, self).__init__()
...
class ConvolutionalBNProcessingBlock(nn.Module):
    def __init__(
        self,
        input_shape,
        num_filters,
        ...
        super(ConvolutionalBNProcessingBlock, self).__init__()
...
class ConvolutionalBNDimensionalityReductionBlock(nn.Module):
    def __init__(
        self,
        input_shape,
        num_filters,
        ...
        super(ConvolutionalBNDimensionalityReductionBlock, self).__init__()
